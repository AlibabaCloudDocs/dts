...
-   已创建目标阿里云Redis实例（2.8、4.0或5.0版本），详情请参见[创建Redis实例](/cn.zh-CN/快速入门/步骤1：创建实例.md)。
...
8.  配置目标已存在表的处理模式和同步对象。
    ...
    ![](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/4349459951/p71226.png)
