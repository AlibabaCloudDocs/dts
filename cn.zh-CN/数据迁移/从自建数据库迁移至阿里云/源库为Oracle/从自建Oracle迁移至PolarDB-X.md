...
1.  根据自建Oracle数据库中待迁移数据表的数据结构，在目标PolarDB-X中创建相应的数据库和数据表，详情请参见[创建数据库](https://help.aliyun.com/document_detail/52090.html)和[SQL基本操作](https://help.aliyun.com/document_detail/117763.html)。
