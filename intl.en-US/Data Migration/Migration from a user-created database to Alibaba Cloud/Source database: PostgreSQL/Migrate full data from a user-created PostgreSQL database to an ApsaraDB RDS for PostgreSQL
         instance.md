...
7.  Select the migration types and the objects to be migrated.
    ...
    ![Select the migration types and the objects to be migrated](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/en-US/4334948951/p47963.png)
