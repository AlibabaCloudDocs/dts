...
6.  Configure the source and destination instances.
    ...
    ![](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/en-US/8030359951/p68675.png)
    ...
    |Database Account|Enter the database account of the source RDS instance. **Note:** If the database type of the source RDS instance is **MySQL 5.5** or **MySQL 5.6**, you do not need to configure the **database account** or **database password**. |
